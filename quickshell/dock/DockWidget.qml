...
PanelWindow {
    ...
    readonly property int margin:     DockConfig.margin
    readonly property int pillHeight: DockConfig.iconSize + 24
    ...
    readonly property bool dockVisible: !DockConfig.autoHide || !windowsPresent || hovering || anyMenuOpen
